...
app.post("/createUser", (req, res) => {
  ...
  const nuevoUsuario = {
    nombre: body.nombre || "Sharely Lilian Gonzalez Velazquez",
    correo: body.correo || "sharely.gonzalez@outlook.com",
  };
...
app.patch("/actualizarPassword/:nuevaPassword", (req, res) => {
  const usuario = {
    nombre: "Sharely Lilian Gonzalez Velazquez",
    correo: "sharely.gonzalez@outlook.com",
    password: "12345678",
  };
